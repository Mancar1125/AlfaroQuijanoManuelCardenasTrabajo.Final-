namespace FinalProgramacion
{
    internal class Program
    {
        ...
        static void verVehiculos()
        {
            ...
            for (int i = 0; i < contarVehiculos; i++)
            {
                Console.WriteLine($"[{i + 1}] Placa: {placas[i]}, Marca: {marcas[i]}, Modelo: {modelos[i]}, Año: {años[i]}");
            }
        }
        ...
        static void editarVehiculo()
        {
            ...
            Console.WriteLine("Edite los datos del vehículo:");
            Console.Write("Nueva marca: ");
            marcas[indice] = Console.ReadLine();
            Console.Write("Nuevo modelo: ");
            modelos[indice] = Console.ReadLine();
            Console.Write("Nuevo año: ");
            años[indice] = int.Parse(Console.ReadLine());
